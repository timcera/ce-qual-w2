...
! END MACROPHYTES
        ...
        IF (JDAY+(DLT/DAY) >= NXTMCP(JW) .OR. JDAY+(DLT/DAY) >= CPLD(CPLDP(JW)+1,JW))THEN
            IF(SEDIMENT_DIAGENESIS)THEN
            WRITE(MASSBFN,'(F10.3,",",1X,I3,",",40(E16.8,",",1X))')JDAY,JW,TPWB,TPSED,TPPLANT,TPOUT(JW),TPTRIB(JW),TPDTRIB(JW),TPWD(JW),TPPR(JW),TPIN(JW),TP_SEDSOD_PO4(JW),PFLUXIN(JW),SDPFLUX(JW),TNWB,TNSED,TNPLANT,TNOUT(JW),TNTRIB(JW),TNDTRIB(JW),TNWD(JW),TNPR(JW),TNIN(JW),TN_SEDSOD_NH4(JW),NFLUXIN(JW),SDNH4FLUX(JW),SDNO3FLUX(JW)    ! TP_SEDBURIAL(JW),TN_SEDBURIAL(JW),
                ELSE
            WRITE(MASSBFN,'(F10.3,",",1X,I3,",",30(E16.8,",",1X))')JDAY,JW,TPWB,TPSED,TPPLANT,TPOUT(JW),TPTRIB(JW),TPDTRIB(JW),TPWD(JW),TPPR(JW),TPIN(JW),TP_SEDSOD_PO4(JW),PFLUXIN(JW),TNWB,TNSED,TNPLANT,TNOUT(JW),TNTRIB(JW),TNDTRIB(JW),TNWD(JW),TNPR(JW),TNIN(JW),TN_SEDSOD_NH4(JW),NFLUXIN(JW)    ! TP_SEDBURIAL(JW),TN_SEDBURIAL(JW),
                ENDIF
        ENDIF
